...
urlpatterns = [
    ...
    # path('home/', books_home, name="homepage"),
    #Create and update without validations
    # path('homedatabase/create/', book_create, name="create"),
    # path('homedatabase/update/<int:id>', book_update, name="update"),
